...
while (true)
{
    ...
    Console.WriteLine("1. View Dashboard Overview");
    Console.WriteLine("2. View All Products");
    Console.WriteLine("3. Add New Product");
    Console.WriteLine("4. View All Suppliers");
    Console.WriteLine("5. Add New Supplier");
    Console.WriteLine("6. View All Orders (Read)");
    Console.WriteLine("7. Add New Order (Create)");
    Console.WriteLine("8. Update Order Status (Update)");
    Console.WriteLine("9. Delete Order (Delete)");
...
// ==========================================
// DASHBOARD OVERVIEW (Imported from Program.cs)
// ==========================================
void ViewDashboardOverview()
{
    Console.WriteLine("======================================");
    ...
    // ---------------------------------------------------------
    // ABSTRACTION
    // We request the data from the DashboardService class.
    // ---------------------------------------------------------
