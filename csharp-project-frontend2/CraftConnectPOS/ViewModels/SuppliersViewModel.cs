...
namespace CraftConnectPOS.ViewModels
{
    public class SuppliersViewModel : ViewModelBase
    {
        ...
        // Keep this constructor parameter so existing navigation code
        // that creates SuppliersViewModel(MockDataStore) does not break.
        ...
        // Location in the UI is stored as Address in SQL Server.
            ...
            try
            {
                ...
                foreach (Supplier supplier in _repository.GetAll())
                {
                    _suppliers.Add(new SupplierItem
                    {
                        ...
                        // This becomes real after Materials/Inventory is connected.
                        Materials = "Inventory not connected"
                    });
                }
        ...
        private void ClearForm()
        {
            ...
            MaterialsSupplied = "Inventory not connected";
            ErrorMessage = string.Empty;
